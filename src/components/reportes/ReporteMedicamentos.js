...
import {
    ...
    Paper, Typography, Grid, CircularProgress, Stack, Chip
} from '@mui/material';
...
import { generarPDFMedicamentos } from './utils/pdfGenerator';
import { generarExcelMedicamentos } from './utils/excelGenerator';

const ReporteMedicamentos = () => {
    ...
    const handleExportarPDF = () => {
        ...
        generarPDFMedicamentos(datosReporte, fechaInicio, fechaFin);
    };

    const handleExportarExcel = () => {
        if (!datosReporte) return;
        generarExcelMedicamentos(datosReporte, fechaInicio, fechaFin);
    };
                ...
                <>
                    ...
                    <Paper sx={{ p: 3 }} id="reporte-print">
                        <Box sx={{ textAlign: 'center', mb: 2 }}>
                            ...
                            <Typography variant="h6">Reporte de Medicamentos Aplicados por Paciente</Typography>
                        ...
                        <Box sx={{ mt: 3, p: 2, bgcolor: 'grey.100', borderRadius: 1 }}>
                            ...
                            <Typography variant="body1">
                                Total de Aplicaciones de Medicamentos: <strong>{datosReporte.totalAplicaciones}</strong>
                            </Typography>
                        </Box>
                    </Paper>
                </>
...
export default ReporteMedicamentos;