...
import { generarPDFPagosFundacion } from './utils/pdfGenerator';
import { generarExcelPagosFundacion } from './utils/excelGenerator';

const ReportePagosFundacion = () => {
    ...
    const generarReporte = async () => {
        ...
        setLoading(true);
        try {
            const res = await api.get('/reportes/pagos-fundacion', {
    ...
    const handleExportarPDF = () => {
        ...
        generarPDFPagosFundacion(datosReporte, fechaInicio, fechaFin);
    };

    const handleExportarExcel = () => {
        if (!datosReporte) return;
        generarExcelPagosFundacion(datosReporte, fechaInicio, fechaFin);
    };
                ...
                <>
                    ...
                    <Paper sx={{ p: 3 }} id="reporte-print">
                        <Box sx={{ textAlign: 'center', mb: 2 }}>
                            ...
                            <Typography variant="h6">Reporte de Pagos a la Fundación</Typography>
...
export default ReportePagosFundacion;